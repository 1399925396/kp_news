      ...
      <div class="head-text2">
        <div class="txt2">
          ...
          <van-button
            ...
            icon="plus"
            style="margin-bottom:20px;margin-left:160px;"
            type="danger"
            size="mini"
          >订阅</van-button>
        </div>
  ...
  methods: {
    ...
    async upstar() {
      try {
        ...
        this.stars.star = parseFloat(this.videos.star);
        let data = this.stars;
    ...
    async getvideoInfo() {
      ...
      try {
        ...
        if (result.code === "0") {
          ...
          this.videos.star = parseFloat(result.data.star);
          console.log(this.videos.star);
